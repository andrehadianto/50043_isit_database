...
const SeeLogList = (props) => {
    ...
    const [url, setUrl] = useState('http://localhost:5000/user/logs?page=1&count=50')
    ...
    const onPageChange = (e, pageInfo) => {
        ...
        setUrl(`http://localhost:5000/user/logs?page=${pageInfo.activePage.toString()}&count=50`)
    }
